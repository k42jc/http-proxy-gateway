  ...
  if (options.cors) {
    ...
    if (options.corsHeaders) {
      ...
      if (options.corsMethods) {
          this.headers['Access-Control-Allow-Methods'] = options.corsMethods;
      }
    before.push(corser.create(options.cors ? {
      requestHeaders: this.headers['Access-Control-Allow-Headers'].split(/\s*,\s*/),
        methods: this.headers['Access-Control-Allow-Methods'].split(/\s*,\s*/),
    } : null));
  }
